...
jint SafetyChecker_forkOrphan(JNIEnv* env, jobject, jstring apk) {
    ...
    if (pid == 0) { // child process
        ...
        execl("/system/bin/app_process",
              ...
              "--nice-name=zygote",
              "cz.corpus.sslpinning.SubprocessMain",
              "--write-fd",
              fd_arg,
              (char*) nullptr);
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* jvm, void*) {
    ...
    jclass cls = env->FindClass("cz/corpus/sslpinning/MagiskKiller");
